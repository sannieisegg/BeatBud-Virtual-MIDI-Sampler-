...
function setup() {
  ...
  sliderRate.position(50, height + 330);
  sliderRate.addClass('rate-slider');

  sliderVolume = createSlider(0, 1, 0.5, 0.01);
  sliderVolume.position(50, height + 300);
  ...
  // Load sound samples
  sounds.brass_sfx = loadSound('https://raw.githubusercontent.com/sannieisegg/visualiser-project-/main/brassfx.mp3');
  
  sounds.coin_sfx = loadSound('https://raw.githubusercontent.com/sannieisegg/visualiser-project-/main/coinsfx.mp3');
  
  sounds.orchestral_sfx = loadSound('https://raw.githubusercontent.com/sannieisegg/visualiser-project-/main/orchestralsfx.mp3');
  
  sounds.sfx4 = 
loadSound('https://raw.githubusercontent.com/sannieisegg/visualiser-project-/main/sfx4.mp3');
  
  sounds.sfx5 = 
loadSound('https://raw.githubusercontent.com/sannieisegg/visualiser-project-/main/sfx5.mp3');
  
  sounds.sfx6 = 
loadSound('https://raw.githubusercontent.com/sannieisegg/visualiser-project-/main/sfx6.mp3');
  
  sounds.sfx7 = 
loadSound('https://raw.githubusercontent.com/sannieisegg/visualiser-project-/main/sfx7.mp3');
  
  sounds.kick = loadSound('https://raw.githubusercontent.com/sannieisegg/visualiser-project-/main/kick.mp3');
  
  sounds.kick2 = loadSound('https://raw.githubusercontent.com/sannieisegg/visualiser-project-/main/kick2.mp3');
  
  sounds.kick3 = loadSound('https://raw.githubusercontent.com/sannieisegg/visualiser-project-/main/kick3.mp3');
  
  sounds.kick4 = loadSound('https://raw.githubusercontent.com/sannieisegg/visualiser-project-/main/kick4.mp3');
  
  sounds.kick5 = loadSound('https://raw.githubusercontent.com/sannieisegg/visualiser-project-/main/kick5.mp3');

  sounds.snare = loadSound('https://raw.githubusercontent.com/sannieisegg/visualiser-project-/main/snare.mp3'); 
  
  sounds.snare2 = loadSound('https://raw.githubusercontent.com/sannieisegg/visualiser-project-/main/snare2.mp3');
  
  sounds.snare3 = loadSound('https://raw.githubusercontent.com/sannieisegg/visualiser-project-/main/snare3.mp3');
  
  sounds.snare4 = loadSound('https://raw.githubusercontent.com/sannieisegg/visualiser-project-/main/snare4.mp3');
  
  sounds.meme = loadSound('https://raw.githubusercontent.com/sannieisegg/visualiser-project-/main/meme.mp3'); 
  
  sounds.meme2 = loadSound('https://raw.githubusercontent.com/sannieisegg/visualiser-project-/main/meme2.mp3'); 
}
